    ...
    <?php echo do_shortcode('[et_pb_section fb_built="1" fullwidth="on" admin_label="Section"]
           ...
           [et_pb_section fb_built="1"]
            ...
            [et_pb_section fb_built="1"]
              ...
              [/et_pb_row]
            [/et_pb_section]
            [et_pb_section bb_built="1" admin_label="section" custom_padding="30px|0px|30px|0px" transparent_background="off" allow_player_pause="off" inner_shadow="off" parallax="off" parallax_method="on" make_fullwidth="off" use_custom_width="off" width_unit="on" make_equal="off" use_custom_gutter="off"]
              [et_pb_row admin_label="row" make_fullwidth="on" custom_padding="0px|0px|0px|0px" disabled_on="off|on|off"]' .
            $txtTestimonios . '
                [et_pb_column type="' . (!empty($txtTestimonios) ? '1_2' : '4_4') . '"]
                  [et_pb_cta admin_label="Call To Action" title="Solicita información" use_background_color="off" background_layout="light" custom_margin="0px|0px|0px|0px" /]
                    [et_pb_code]
