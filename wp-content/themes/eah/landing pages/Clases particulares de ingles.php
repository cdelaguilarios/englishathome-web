<?php /* Template Name: LP Clases particulares de inglés*/ ?>
<?php get_header(); ?>
...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">Clases Particulares de Inglés</h1>
					...
					<div class="texto2">
						...
						<div class="texto4">
							<ul>
								...
								<li>- Planifica tus clases en tu domicilio u oficina.</li>
