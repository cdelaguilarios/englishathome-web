<?php /* Template Name:LP Examen de suficiencia de la Universidad Pacífico*/ ?>
<?php get_header(); ?>
...
<style type="text/css">
	...
	.imagendefondo{
		    background-image: url(http://englishathomeperu.com/wp-content/uploads/2017/07/eah_curso_suficiencia_pacifico.png);
    color: white;
...
<div id="seccion1">
	<div class="container">
		<div class="col-md-4 logo">
			<a href="http://englishathomeperu.com"><img src="http://englishathomeperu.com/wp-content/uploads/2017/07/eah_logo.png"></a>
		</div>
		<div class="col-md-8">
			<h1 class="titulolp">Exámen de Suficiencia Universidad del Pacifico</h1>
			<h2 class="subtitulolp">¡Te preparamos para tu Exámen!</h2>
		</div>
	</div>
</div>
			...
			<div class="container">
				...
				<div class="col-md-7">
					<div class="texto2">
						...
						<div class="texto4">
							<img src="http://englishathomeperu.com/wp-content/uploads/2017/09/LOGO-PACIFICO.png">
						</div>
					</div>		
				</div>
...
<div id="seccion3">
	...
	<div class="separador"></div>
		<div class="col-md-6">
			<p>Este programa ha sido diseñado exclusivamente para alumnos y exalumnos universitarios que desean obtener su Bachiller convalidando su Nivel de Inglés a través del Examen de Suficiencia de la universidad Pacífico.
El programa consta de 40 horas las cuales se distribuyen de tal forma que el alumno pueda lograr el puntaje requerido por la universidad para poder graduarse.
			</p>
		</div>
		<div class="col-md-6">
			<ul>
		...
		<ul>
			<li>
				...
				<h3>Programa completo 40 Horas</h3>
			</li>
		</ul>	
		</div>
	</div>
...
<div id="seccion4">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
		<p>Nuestra metodología ha logrado excelentes resultados con la gran mayoría de nuestros alumnos. Familiarización con el formato - Estrategias - Práctica y Feedback constante. Esto nos permite conocer cuál es la estructura del examen y en qué condiciones se toma, saber como resolver y qué esperar de cada tipo de pregunta y resolver una serie de exámenes completos para estar listo para todas las posibles preguntas.
			</p>
...
<div id="seccion5">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
			<p>Aunque recomendamos que el programa se lleve completamente (40 horas), este puede ser adaptado en enfoque y duración. Enfatizando más alguna de las habilidades así como aumentando o reduciendo el número de horas para de ese modo adecuarnos a las necesidades específicas de cada uno de nuestros alumnos.
			</p>
		</div>
		<div class="col-md-6">
			<img class="imgl1" src="http://englishathomeperu.com/wp-content/uploads/2017/07/eah_logo_curso_universidad_de_la_pacifico.png">
			<img class="imgl2" src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_universidad_de_lima.png">
		</div>
	</div>
</div>
