<?php /* Template Name:LP Profesor particular de inglés*/ ?>
<?php get_header(); ?>
...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">Profesores particulares de Inglés</h1>
...
<div id="seccion5">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
			<img src="http://englishathomeperu.com/wp-content/uploads/2017/07/eah_american_english_file_2.png">
		</div>
	</div>
</div>
