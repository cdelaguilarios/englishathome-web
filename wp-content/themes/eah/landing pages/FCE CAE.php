...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">¡Te Preparamos para el FCE - CAE!</h1>
			...
			<div class="container">
				...
				<div class="col-md-7">
					<div class="texto2">
						...
						<div class="texto4">
							<img src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_fce.png">
							<img src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_cae.png">
						</div>
					</div>		
				</div>
...
Los exámenes de la universidad de Cambridge FCE y CAE son dos de los exámenes internacionales más solicitados y reconocidos a nivel mundial. Estos constan de un formato que evalúan las 4 competencias del idioma: Reading (y Use of English), Listening, Speaking and Writing y tienen una duración de aproximadamente 3 horas y media. 
English at Home ha diseñado un programa exclusivo de preparación que se enfoca en la obtención del puntaje requerido a través del uso de un material compuesto de una bateria de examenes completos.
...
<div id="seccion5">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
			<p>
			Aunque recomendamos que el programa se lleve completamente (50 horas), este puede ser adaptado en enfoque y duración. Enfatizando más alguna de las habilidades así como aumentando o reduciendo el número de horas para de ese modo adecuarnos a las necesidades específicas de cada uno de nuestros alumnos.
			</p>
		</div>
		<div class="col-md-6">
			<img src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_fce.png">
