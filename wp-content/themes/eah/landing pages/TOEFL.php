...
<style type="text/css">
	...
	.imagendefondo{
		    background-image: url(http://englishathomeperu.com/wp-content/uploads/2017/07/eah_curso_toefl.jpg);
    color: white;
...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">¡Te Preparamos para el TOEFL!</h1>
...
<div id="seccion6">
			<div class="container">
				<div class="cta">
					<div class="col-md-9">
							<div class="tmiddle">
								<p>Bríndenos sus datos y reciba en su correo un SIMULADOR con ¡2 tests completos!
								</p>
							</div>
					</div>
					<div class="col-md-3">
