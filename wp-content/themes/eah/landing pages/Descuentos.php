<?php /* Template Name:LP Descuentos*/ ?>
<?php get_header(); ?>
...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">¡Agradecemos y valoramos tu preferencia!</h1>
			<h2 class="subtitulolp">Asegura tu Bachiller</h2>
		</div>
	</div>
</div>
			...
			<div class="container">
				...
				<div class="col-md-7">
					<div class="texto2">
						...
						<div class="texto4">
							<img src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_toeic.png">
						</div>
					</div>		
				</div>
...
<div id="seccion3">
	...
	<div class="separador"></div>
		<div class="col-md-6">
			<p>El TOEIC es un examen internacional de complejidad media que permite a la mayoría de alumnos universitarios convalidar su nivel de Inglés. Este examen es administrado por la ETS y es reconocido por diversas universidades y empresas y es una excelente alternativa a exámenes de alta complejidad como el FCE, TOEFL o IELTS debido a que tenemos la opción de tomar solo la parte de Listening y Reading para cualquier propósito.
...
<div id="seccion5">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
			<img src="http://englishathomeperu.com/wp-content/uploads/2017/07/eah_logo_curso_toefl.png">
		</div>
	</div>
</div>
