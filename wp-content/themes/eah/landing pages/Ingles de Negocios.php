<?php /* Template Name:LP Inglés de Negocios*/ ?>
<?php get_header(); ?>
...
<style type="text/css">
	...
	.imagendefondo{
		    background-image: url(http://englishathomeperu.com/wp-content/uploads/2017/09/lpie.jpg);
    color: white;
...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">Inglés para Empresas</h1>
			<h2 class="subtitulolp">Aprende inglés en la comodidad de tu oficina</h2>
		</div>
	</div>
</div>
			...
			<div class="container">
				...
				<div class="col-md-7">
					<div class="texto2">
						...
						<div class="texto4">
							<ul>
								<li>- Clases de inglés adaptadas a tus necesidades.</li>
								<li>- Profesores particulares altamente calificados.</li>
								<li>- Elige el Horario de tu preferencia.</li>
								
								<li>- Desarrollo de la comunicación</li>
								<li>- Metodología exclusiva.</li>
							</ul>
...
<div id="seccion3">
	...
	<div class="separador"></div>
		<div class="col-md-6">
			<p>Programa de Inglés diseñado para adquirir y mejorar las competencias del idioma Inglés con un enfoque Empresarial y de Negocios. Ideal para profesionales, ejecutivos, empresarios y emprendedores que requieren utilizar el idioma en un entorno empresarial.
			</p>
		</div>
		<div class="col-md-6">
...
<div id="seccion5">
	...
	<div class="separador"></div>
		...
		<div class="col-md-6">
			<img src="http://englishathomeperu.com/wp-content/uploads/2017/07/eah_business_result_2.png">
		</div>
	</div>
</div>
