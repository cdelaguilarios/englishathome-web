...
<div id="seccion1">
	<div class="container">
		...
		<div class="col-md-8">
			<h1 class="titulolp">¡Te Preparamos para el IELTS!</h1>
			<h2 class="subtitulolp">(International English Language Testing System)</h2>
		</div>
	</div>
</div>
			...
			<div class="container">
				...
				<div class="col-md-7">
					<div class="texto2">
						...
						<div class="texto4">
							<img src="http://englishathomeperu.com/wp-content/uploads/2017/08/eah_logo_curso_ielts.png">
						</div>
					</div>		
				</div>
...
<div id="seccion3">
	...
	<div class="separador"></div>
		<div class="col-md-6">
			<p>
El IELTS es uno de los exámenes de inglés internacionales más solicitados y reconocidos a nivel mundial. Este consta de dos formatos distintos (General y Académico) que evalúan las 4 competencias del idioma: Reading, Listening, Speaking and Writing y que tiene una duración de aproximadamente 3 horas y media. 
