...
* beautiful drop-down-menues with post image and excerpt
...
1. The posts image drop-down-menu in action
2. The post fields in action
3. Post select field generator
